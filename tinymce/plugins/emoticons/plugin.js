...
var emoticons = (function () {
  ...
  var $_9ovxijahjepbv9nm = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_9ovxijahjepbv9nm.getHtml(pluginUrl);
  ...
  var $_fgoz04agjepbv9nk = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_fgoz04agjepbv9nk.register(editor, pluginUrl);
  });
  function Plugin () {
  }
