...
var help = (function () {
  ...
  var never$1 = $_d24sx6aqjepbv9p4.never;
  var always$1 = $_d24sx6aqjepbv9p4.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_d24sx6aqjepbv9p4.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_c9lqyaasjepbv9pa = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_2ots16aojepbv9om.map($_c9lqyaasjepbv9pa.shortcuts, function (shortcut) {
  ...
  var $_42pgzcanjepbv9oa = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_3ei722axjepbv9q5.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_3ei722axjepbv9q5.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_3ei722axjepbv9q5.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_3ei722axjepbv9q5.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_dgmfu1ayjepbv9q7.head(str).bind(function (head) {
      return $_dgmfu1ayjepbv9q7.tail(str).map(function (tail) {
  ...
  var $_c7e5b9azjepbv9qb = { urls: urls };

  var makeLink = $_d24sx6aqjepbv9p4.curry($_1ihbmawjepbv9q2.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_2ots16aojepbv9om.find($_c7e5b9azjepbv9qb.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_2isl45avjepbv9pw.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_2ots16aojepbv9om.filter(keys, $_d24sx6aqjepbv9p4.not($_d24sx6aqjepbv9p4.curry($_2ots16aojepbv9om.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_2ots16aojepbv9om.map(pluginKeys, function (key) {
  ...
  var $_79bfvcaujepbv9pj = { makeTab: makeTab$1 };
  ...
  var $_4yi2pb0jepbv9qe = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_42pgzcanjepbv9oa.makeTab(),
          $_79bfvcaujepbv9pj.makeTab(editor)
        ],
        buttons: $_4yi2pb0jepbv9qe.makeRow(),
  ...
  var $_61lfyhamjepbv9o8 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_61lfyhamjepbv9o8.open(editor, pluginUrl));
  };
  var $_dflu6oaljepbv9o6 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_61lfyhamjepbv9o8.open(editor, pluginUrl)
    });
  ...
  var $_229at8b2jepbv9qg = { register: register$1 };

  PluginManager.add('help', function (editor, pluginUrl) {
    $_229at8b2jepbv9qg.register(editor, pluginUrl);
    $_dflu6oaljepbv9o6.register(editor, pluginUrl);
