...
var contextmenu = (function () {
  ...
  var $_80d0vaa2jepbv9md = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_8mafiga1jepbv9mb.getContextMenu(editor);
  ...
  var $_fxsmn7a5jepbv9ml = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_8mafiga1jepbv9mb.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_fxsmn7a5jepbv9ml.show(editor, $_80d0vaa2jepbv9md.getPos(editor, e), visibleState, menu);
    });
  };
  var $_4y1u22a0jepbv9ma = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_4y1u22a0jepbv9ma.setup(editor, visibleState, menu);
    return $_5cg4kw9zjepbv9m8.get(visibleState);
  });
  function Plugin () {
  }
