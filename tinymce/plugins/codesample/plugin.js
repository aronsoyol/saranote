...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_1wtn2z9njepbv9k2.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_cenqrr9jjepbv9ik.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_4bwauc9ljepbv9im.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_eicf2p9ojepbv9k4 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_21465x9ijepbv9ie = {
    open: function (editor) {
      var minWidth = $_cenqrr9jjepbv9ik.getDialogMinWidth(editor);
      var minHeight = $_cenqrr9jjepbv9ik.getDialogMinHeight(editor);
      var currentLanguage = $_eicf2p9ojepbv9k4.getCurrentLanguage(editor);
      var currentLanguages = $_eicf2p9ojepbv9k4.getLanguages(editor);
      var currentCode = $_4bwauc9ljepbv9im.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_4bwauc9ljepbv9im.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_1wtn2z9njepbv9k2.isCodeSample(node)) {
        $_21465x9ijepbv9ie.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_132ow19hjepbv9id = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_1wtn2z9njepbv9k2.trimArg($_1wtn2z9njepbv9k2.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_1wtn2z9njepbv9k2.trimArg($_1wtn2z9njepbv9k2.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_8tx2db9pjepbv9k7 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_cenqrr9jjepbv9ik.getContentCss(editor);
  ...
  var $_8kvcx9qjepbv9k9 = { loadCss: loadCss };
  ...
  var $_70s3229rjepbv9kb = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_8tx2db9pjepbv9k7.setup(editor);
    $_70s3229rjepbv9kb.register(editor);
    $_132ow19hjepbv9id.register(editor);
    editor.on('init', function () {
      $_8kvcx9qjepbv9k9.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_1wtn2z9njepbv9k2.isCodeSample(ev.target)) {
        $_21465x9ijepbv9ie.open(editor);
      }
    });
  });
