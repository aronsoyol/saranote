...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_10ktthi6jepbvauw.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_10ktthi6jepbvauw.getPreviewDialogWidth(editor);
    var dialogHeight = $_10ktthi6jepbvauw.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_4th9lzi7jepbvauy.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_9mnagei4jepbvauu = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_9mnagei4jepbvauu.open(editor);
    });
  };
  var $_g2k425i3jepbvaus = { register: register };
  ...
  var $_f0z3kzi9jepbvav1 = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_g2k425i3jepbvaus.register(editor);
    $_f0z3kzi9jepbvav1.register(editor);
  });
  function Plugin () {
  }
