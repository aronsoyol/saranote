...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_b16br6e5jepbvaaz.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_b16br6e5jepbvaaz.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_b16br6e5jepbvaaz.getSelectorConverter(editor)) {
      selectorConverter = $_b16br6e5jepbvaaz.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_b16br6e5jepbvaaz.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_b16br6e5jepbvaaz.getCssGroups(editor));
      ...
      if (!$_b16br6e5jepbvaaz.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_b16br6e5jepbvaaz.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_g2h3uce0jepbvaak.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_23mdz1dzjepbvaah = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_g2h3uce0jepbvaak.setup(editor);
    return $_23mdz1dzjepbvaah.get(editor);
  });
  function Plugin () {
  }
