...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_dj2vhr8cjepbv9dn.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_dj2vhr8cjepbv9dn.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_dj2vhr8cjepbv9dn.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_dj2vhr8cjepbv9dn.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_dj2vhr8cjepbv9dn.getAutoResizeBottomMargin(editor);
    ...
    if ($_dj2vhr8cjepbv9dn.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_6hdlla89jepbv9di.resize(editor, oldSize);
    });
  };
  var $_7hx0t388jepbv9de = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_7hx0t388jepbv9de.register(editor, oldSize);
      $_6hdlla89jepbv9di.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
