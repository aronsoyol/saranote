...
var tabfocus = (function () {
  ...
  var $_b76rlrjmjepbvb0q = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_b76rlrjmjepbvb0q.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_djo3objfjepbvb0m = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_djo3objfjepbvb0m.setup(editor);
  });
  function Plugin () {
  }
