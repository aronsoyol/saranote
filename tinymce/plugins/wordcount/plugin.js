...
var wordcount = (function () {
  ...
  var $_bdjzous4jepbvd8z = {
    each: each,
    map: map
  };

  var SETS$1 = $_ch8zybs2jepbvd8s.SETS;
  var OTHER = $_ch8zybs2jepbvd8s.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_bdjzous4jepbvd8z.map(string.split(''), memoized);
  };
  var $_8vo0oqs3jepbvd8x = { classify: classify };

  var ci = $_ch8zybs2jepbvd8s.characterIndices;
  ...
  var $_c3eqgzs5jepbvd92 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_ch8zybs2jepbvd8s.EMPTY_STRING;
  var WHITESPACE$1 = $_ch8zybs2jepbvd8s.WHITESPACE;
  var PUNCTUATION$1 = $_ch8zybs2jepbvd8s.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_8vo0oqs3jepbvd8x.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_c3eqgzs5jepbvd92.isWordBoundary(map, i)) {
  ...
  var $_ffqwjjs1jepbvd8m = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_ffqwjjs1jepbvd8m.getWords(getTextContent(editor)).length;
  };
  var $_1vmikos0jepbvd8h = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_1vmikos0jepbvd8h.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_5v4z3drzjepbvd8f = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_1vmikos0jepbvd8h.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_7nphh9s6jepbvd97 = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_7nphh9s6jepbvd97.setup(editor);
    return $_5v4z3drzjepbvd8f.get(editor);
  });
  function Plugin () {
  }
