...
var inlite = (function () {
  ...
  var $_76o8um16ijepbvh82 = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_g4nwy516mjepbvh89.fromClientRect(clientRect)) : null;
  };
  var $_c2c7jv16ljepbvh87 = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_8kodtx16kjepbvh85.result(predicateIds[i].id, $_c2c7jv16ljepbvh87.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_8kodtx16kjepbvh85.result(predicateIds[x].id, $_c2c7jv16ljepbvh87.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_8kodtx16kjepbvh85.result(id, $_c2c7jv16ljepbvh87.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_8kodtx16kjepbvh85.result(id, $_c2c7jv16ljepbvh87.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_jk77w16vjepbvh8m.isArray(value)) {
      return value;
    } else if ($_jk77w16vjepbvh8m.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_jk77w16vjepbvh8m.isBoolean(value)) {
  ...
  var $_du3i6516ujepbvh8k = {
    getStringOr: getByTypeOr($_jk77w16vjepbvh8m.isString),
    getBoolOr: getByTypeOr($_jk77w16vjepbvh8m.isBoolean),
    getNumberOr: getByTypeOr($_jk77w16vjepbvh8m.isNumber),
    getHandlerOr: getByTypeOr($_jk77w16vjepbvh8m.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_jk77w16vjepbvh8m.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_g4nwy516mjepbvh89.toClientRect(targetRect),
        contentAreaRect: $_g4nwy516mjepbvh89.toClientRect(contentAreaRect),
        panelRect: $_g4nwy516mjepbvh89.toClientRect(panelRect)
      });
      return $_g4nwy516mjepbvh89.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_du3i6516ujepbvh8k.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_du3i6516ujepbvh8k.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_du3i6516ujepbvh8k.getHandlerOr(editor, 'inline_toolbar_position_handler', $_e1ibc816wjepbvh8n.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_2un76e16rjepbvh8f.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_f4sf3316sjepbvh8g.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_f4sf3316sjepbvh8g.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_1w8o4q16qjepbvh8e = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_76o8um16ijepbvh82.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_7pyl2a16njepbvh8b.fromContextToolbars(toolbars);
    result = $_8kodtx16kjepbvh85.match(editor, [
      $_4lf2zs16jjepbvh83.element(elements[0], contextToolbarsPredicateIds),
      $_1xvvbs16pjepbvh8c.textSelection('text'),
      $_1xvvbs16pjepbvh8c.emptyTextBlock(elements, 'insert'),
      $_4lf2zs16jjepbvh83.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_8kodtx16kjepbvh85.match(editor, [$_1xvvbs16pjepbvh8c.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_1w8o4q16qjepbvh8e.load(editor, function () {
  ...
  var $_8nk7yt16ejepbvh7s = { renderUI: renderUI };
  ...
  var never$1 = $_85l037171jepbvh93.never;
  var always$1 = $_85l037171jepbvh93.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_85l037171jepbvh93.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_1sz3tl178jepbvha1.parseBox(settings.border);
      self.paddingBox = $_1sz3tl178jepbvha1.parseBox(settings.padding);
      self.marginBox = $_1sz3tl178jepbvha1.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_5llsgq17gjepbvhat.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_1sz3tl178jepbvha1.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_1sz3tl178jepbvha1.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_1sz3tl178jepbvha1.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_10diqo17fjepbvhar.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_5llsgq17gjepbvhat.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_5llsgq17gjepbvhat.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_duqlu017hjepbvhaz = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_5llsgq17gjepbvhat.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_5llsgq17gjepbvhat.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_c8r8bw16zjepbvh8v.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_c8r8bw16zjepbvh8v.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_1sz3tl178jepbvha1.parseBox(self.settings.border);
          ...
          self.borderBox = $_1sz3tl178jepbvha1.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_8nk7yt16ejepbvh7s.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_abffit16djepbvh7p = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_bduwf7180jepbvhdj.resolve(name, scope);
  };
  ...
  var $_33fwk817zjepbvhdg = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_33fwk817zjepbvhdg.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_43czjl17xjepbvhda = { blobToBase64: blobToBase64 };
  ...
  var $_fqwlrq183jepbvhdn = { pickFile: pickFile };
  ...
  var $_cx3vxo185jepbvhdt = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_36m7dy187jepbvhdx.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_36m7dy187jepbvhdx.resolve(dom, bookmark));
  };
  ...
  var $_65bvsj186jepbvhdu = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_cx3vxo185jepbvhdt.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_65bvsj186jepbvhdu.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_blbpjq184jepbvhdq.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_fqwlrq183jepbvhdn.pickFile().then(function (files) {
          var blob = files[0];
          $_43czjl17xjepbvhda.blobToBase64(blob).then(function (base64) {
            $_blbpjq184jepbvhdq.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_blbpjq184jepbvhdq.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_e855h517wjepbvhd7 = { addToEditor: addToEditor };
  ...
  var $_b4m5af18bjepbvhef = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_etzgnt18djepbvhen.isAbsolute(href) && $_etzgnt18djepbvhen.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_blbpjq184jepbvhdq.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_blbpjq184jepbvhdq.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_39mnfp18cjepbvhei = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_jk77w16vjepbvh8m.isArray(items)) {
      return items;
    } else if ($_jk77w16vjepbvh8m.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    Tools.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_jk77w16vjepbvh8m.isFunction(button)) {
            button = button();
          }
  ...
  var $_3vrzpz18ejepbvhep = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_3vrzpz18ejepbvhep.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_3vrzpz18ejepbvhep.create(editor, 'text', $_f4sf3316sjepbvh8g.getTextSelectionToolbarItems(editor)),
        $_3vrzpz18ejepbvhep.create(editor, 'insert', $_f4sf3316sjepbvh8g.getInsertToolbarItems(editor)),
        $_39mnfp18cjepbvhei.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_f4sf3316sjepbvh8g.getPositionHandler(editor);
      contentAreaRect = $_c2c7jv16ljepbvh87.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_e1ibc816wjepbvh8n.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_e1ibc816wjepbvh8n.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_b4m5af18bjepbvhef.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_e1ibc816wjepbvh8n.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_c2c7jv16ljepbvh87.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_e1ibc816wjepbvh8n.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_e1ibc816wjepbvh8n.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_2un76e16rjepbvh8f.fireBeforeRenderUI(editor);
  ...
  var $_al0d1v191jepbvhgt = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_85l037171jepbvh93.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_ftrhrp192jepbvhgw = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_bwmmv9196jepbvhhb = { cached: cached };

  var $_aryoag198jepbvhhe = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_aryoag198jepbvhhe.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_aryoag198jepbvhhe.ELEMENT);
  var isText = isType$1($_aryoag198jepbvhhe.TEXT);
  var isDocument = isType$1($_aryoag198jepbvhhe.DOCUMENT);
  var $_4am7y197jepbvhhd = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_4am7y197jepbvhhd.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_bwmmv9196jepbvhhb.cached(function () {
    return getBody($_ftrhrp192jepbvhgw.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_ftrhrp192jepbvhgw.fromDom(body);
  };
  var $_anu5wx195jepbvhh7 = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_c8r8bw16zjepbvh8v.each(fields, function (name, i) {
        struct[name] = $_85l037171jepbvh93.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_279qck19ajepbvhhr.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_c8r8bw16zjepbvh8v.each(array, function (a) {
      if (!$_279qck19ajepbvhhr.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_c8r8bw16zjepbvh8v.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_6bylme19fjepbvhi2.validateStrArr('required', required);
    $_6bylme19fjepbvhi2.validateStrArr('optional', optional);
    $_6bylme19fjepbvhi2.checkDupes(everything);
    return function (obj) {
      var keys = $_3m9eza19ejepbvhhz.keys(obj);
      var allReqd = $_c8r8bw16zjepbvh8v.forall(required, function (req) {
        return $_c8r8bw16zjepbvh8v.contains(keys, req);
      });
      if (!allReqd)
        $_6bylme19fjepbvhi2.reqMessage(required, keys);
      var unsupported = $_c8r8bw16zjepbvh8v.filter(keys, function (key) {
        return !$_c8r8bw16zjepbvh8v.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_6bylme19fjepbvhi2.unsuppMessage(unsupported);
      var r = {};
      $_c8r8bw16zjepbvh8v.each(required, function (req) {
        r[req] = $_85l037171jepbvh93.constant(obj[req]);
      });
      $_c8r8bw16zjepbvh8v.each(optional, function (opt) {
        r[opt] = $_85l037171jepbvh93.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_5zjpt519bjepbvhht = {
    immutable: Immutable,
  ...
  var $_apzqu719gjepbvhi8 = { toArray: toArray };

  var node = function () {
    var f = $_33fwk817zjepbvhdg.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_4xmgk19mjepbvhis.unknown()
    });
  };
  ...
  var $_bqmi6l19ljepbvhip = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_85l037171jepbvh93.constant(edge),
    chrome: $_85l037171jepbvh93.constant(chrome),
    ie: $_85l037171jepbvh93.constant(ie),
    opera: $_85l037171jepbvh93.constant(opera),
    firefox: $_85l037171jepbvh93.constant(firefox),
    safari: $_85l037171jepbvh93.constant(safari)
  };
  ...
  var $_2qhk1n19njepbvhit = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_85l037171jepbvh93.constant(windows$1),
    ios: $_85l037171jepbvh93.constant(ios),
    android: $_85l037171jepbvh93.constant(android),
    linux: $_85l037171jepbvh93.constant(linux),
    osx: $_85l037171jepbvh93.constant(osx),
    solaris: $_85l037171jepbvh93.constant(solaris),
    freebsd: $_85l037171jepbvh93.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_85l037171jepbvh93.constant(isiPad),
      isiPhone: $_85l037171jepbvh93.constant(isiPhone),
      isTablet: $_85l037171jepbvh93.constant(isTablet),
      isPhone: $_85l037171jepbvh93.constant(isPhone),
      isTouch: $_85l037171jepbvh93.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_85l037171jepbvh93.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_c8r8bw16zjepbvh8v.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_4xmgk19mjepbvhis.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_4xmgk19mjepbvhis.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_1az8sz19sjepbvhje.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_1az8sz19sjepbvhje.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_1az8sz19sjepbvhje.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_1az8sz19sjepbvhje.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_gfi2ux19tjepbvhjf.head(str).bind(function (head) {
      return $_gfi2ux19tjepbvhjf.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_ej7cez19rjepbvhjc.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_ej7cez19rjepbvhjc.contains(uastring, 'edge/') && $_ej7cez19rjepbvhjc.contains(uastring, 'chrome') && $_ej7cez19rjepbvhjc.contains(uastring, 'safari') && $_ej7cez19rjepbvhjc.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_ej7cez19rjepbvhjc.contains(uastring, 'chrome') && !$_ej7cez19rjepbvhjc.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_ej7cez19rjepbvhjc.contains(uastring, 'msie') || $_ej7cez19rjepbvhjc.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_ej7cez19rjepbvhjc.contains(uastring, 'safari') || $_ej7cez19rjepbvhjc.contains(uastring, 'mobile/')) && $_ej7cez19rjepbvhjc.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_ej7cez19rjepbvhjc.contains(uastring, 'iphone') || $_ej7cez19rjepbvhjc.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_1lej9m19qjepbvhj6 = {
    browsers: $_85l037171jepbvh93.constant(browsers),
    oses: $_85l037171jepbvh93.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_1lej9m19qjepbvhj6.browsers();
    var oses = $_1lej9m19qjepbvhj6.oses();
    var browser = $_rfk0b19pjepbvhj3.detectBrowser(browsers, userAgent).fold($_bqmi6l19ljepbvhip.unknown, $_bqmi6l19ljepbvhip.nu);
    var os = $_rfk0b19pjepbvhj3.detectOs(oses, userAgent).fold($_2qhk1n19njepbvhit.unknown, $_2qhk1n19njepbvhit.nu);
  ...
  var $_fya6wd19kjepbvhin = { detect: detect$2 };

  var detect$3 = $_bwmmv9196jepbvhhb.cached(function () {
    var userAgent = navigator.userAgent;
    return $_fya6wd19kjepbvhin.detect(userAgent);
  });
  var $_1d2xw019jjepbvhil = { detect: detect$3 };

  var ELEMENT = $_aryoag198jepbvhhe.ELEMENT;
  var DOCUMENT = $_aryoag198jepbvhhe.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_c8r8bw16zjepbvh8v.map(base.querySelectorAll(selector), $_ftrhrp192jepbvhgw.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_ftrhrp192jepbvhgw.fromDom);
  };
  var $_ebo7kc19ujepbvhjh = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_c8r8bw16zjepbvh8v.exists(elements, $_85l037171jepbvh93.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_dd1wth19ijepbvhij.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_1d2xw019jjepbvhil.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_557e6919hjepbvhia = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_ebo7kc19ujepbvhjh.is
  };

  var owner = function (element) {
    return $_ftrhrp192jepbvhgw.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_ftrhrp192jepbvhgw.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_ftrhrp192jepbvhgw.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_ftrhrp192jepbvhgw.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_c8r8bw16zjepbvh8v.findIndex(kin, function (elem) {
        return $_557e6919hjepbvhia.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_279qck19ajepbvhhr.isFunction(isRoot) ? isRoot : $_85l037171jepbvh93.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_ftrhrp192jepbvhgw.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_c8r8bw16zjepbvh8v.filter(elements, function (x) {
        return !$_557e6919hjepbvhia.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_ftrhrp192jepbvhgw.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_ftrhrp192jepbvhgw.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_ftrhrp192jepbvhgw.fromDom);
  };
  var prevSiblings = function (element) {
    return $_c8r8bw16zjepbvh8v.reverse($_apzqu719gjepbvhi8.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_apzqu719gjepbvhi8.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_c8r8bw16zjepbvh8v.map(dom.childNodes, $_ftrhrp192jepbvhgw.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_ftrhrp192jepbvhgw.fromDom);
  };
  ...
  var spot = $_5zjpt519bjepbvhht.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_5pyj7z199jepbvhhg = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_anu5wx195jepbvhh7.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_c8r8bw16zjepbvh8v.filter($_5pyj7z199jepbvhhg.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_c8r8bw16zjepbvh8v.filter($_5pyj7z199jepbvhhg.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_c8r8bw16zjepbvh8v.filter($_5pyj7z199jepbvhhg.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_c8r8bw16zjepbvh8v.each($_5pyj7z199jepbvhhg.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_ebo7kc19ujepbvhjh.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_frzif6194jepbvhh4.ancestors(scope, function (e) {
      return $_ebo7kc19ujepbvhjh.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_frzif6194jepbvhh4.siblings(scope, function (e) {
      return $_ebo7kc19ujepbvhjh.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_frzif6194jepbvhh4.children(scope, function (e) {
      return $_ebo7kc19ujepbvhjh.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_ebo7kc19ujepbvhjh.all(selector, scope);
  };
  var $_7cwv90193jepbvhh2 = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_c8r8bw16zjepbvh8v.map($_7cwv90193jepbvhh2.descendants($_ftrhrp192jepbvhgw.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_al0d1v191jepbvhgt.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_85l037171jepbvh93.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_c8r8bw16zjepbvh8v.map($_c8r8bw16zjepbvh8v.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_c8r8bw16zjepbvh8v.map($_c8r8bw16zjepbvh8v.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_c8r8bw16zjepbvh8v.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_e8o36d190jepbvhgl = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_85l037171jepbvh93.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_c8r8bw16zjepbvh8v.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_c8r8bw16zjepbvh8v.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_c8r8bw16zjepbvh8v.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_c8r8bw16zjepbvh8v.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_c8r8bw16zjepbvh8v.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_e8o36d190jepbvhgl.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_279qck19ajepbvhhr.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_anu5wx195jepbvhh7.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_ftrhrp192jepbvhgw.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_ftrhrp192jepbvhgw.fromDom(element.parentNode), function (x) {
      return !$_557e6919hjepbvhia.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_c8r8bw16zjepbvh8v.find(scope.dom().childNodes, $_85l037171jepbvh93.compose(predicate, $_ftrhrp192jepbvhgw.fromDom));
    return result.map($_ftrhrp192jepbvhgw.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_ftrhrp192jepbvhgw.fromDom(element.childNodes[i])))
          return Option.some($_ftrhrp192jepbvhgw.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_ebo7kc19ujepbvhjh.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_ewmdvj1a0jepbvhjz.ancestor(scope, function (e) {
      return $_ebo7kc19ujepbvhjh.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_ewmdvj1a0jepbvhjz.sibling(scope, function (e) {
      return $_ebo7kc19ujepbvhjh.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_ewmdvj1a0jepbvhjz.child(scope, function (e) {
      return $_ebo7kc19ujepbvhjh.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_ebo7kc19ujepbvhjh.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_ebo7kc19ujepbvhjh.is, ancestor$1, scope, selector, isRoot);
  };
  var $_2zektj19zjepbvhjx = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_cswy1v1a3jepbvhkj.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_cswy1v1a3jepbvhkj.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_cswy1v1a3jepbvhkj.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_cswy1v1a3jepbvhkj.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_cswy1v1a3jepbvhkj.postRenderFormat(editor, name)
      });
    });
  };
  var $_9p28zi1a2jepbvhkh = { register: register };
  ...
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return Option.from(elm).map($_ftrhrp192jepbvhgw.fromDom).filter($_4am7y197jepbvhhd.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_b83nvh1a5jepbvhkn = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_85l037171jepbvh93.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_b83nvh1a5jepbvhkn.getFontFamily(editor.getBody(), e.element);
  ...
  var getFontItems = function (editor) {
    var defaultFontsFormats =  'Mongolian White=mongolian white;' + 'Andale Mono=andale mono,monospace;' + 'Arial=arial,helvetica,sans-serif;' + 'Arial Black=arial black,sans-serif;' + 'Book Antiqua=book antiqua,palatino,serif;' + 'Comic Sans MS=comic sans ms,sans-serif;' + 'Courier New=courier new,courier,monospace;' + 'Georgia=georgia,palatino,serif;' + 'Helvetica=helvetica,arial,sans-serif;' + 'Impact=impact,sans-serif;' + 'Symbol=symbol;' + 'Tahoma=tahoma,arial,helvetica,sans-serif;' + 'Terminal=terminal,monaco,monospace;' + 'Times New Roman=times new roman,times,serif;' + 'Trebuchet MS=trebuchet ms,geneva,sans-serif;' + 'Verdana=verdana,geneva,sans-serif;' + 'Webdings=webdings;' + 'Wingdings=wingdings,zapf dingbats';
  ...
  var $_5p8dj91a4jepbvhkk = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_b83nvh1a5jepbvhkn.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_b83nvh1a5jepbvhkn.toPt(px, precision);
  ...
  var $_3z1ode1a6jepbvhku = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_cswy1v1a3jepbvhkj.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_49hp5u1a7jepbvhkx = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_cswy1v1a3jepbvhkj.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_cswy1v1a3jepbvhkj.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_b8glwm1a8jepbvhl1 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_c8r8bw16zjepbvh8v.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_c8r8bw16zjepbvh8v.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_c8r8bw16zjepbvh8v.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_bexn0c1a9jepbvhl4 = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_cswy1v1a3jepbvhkj.postRenderFormat(editor, name),
        onclick: $_cswy1v1a3jepbvhkj.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_cswy1v1a3jepbvhkj.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_51upis1aajepbvhla = { register: register$6 };
  ...
  var $_6qj2b21abjepbvhld = { register: register$7 };
  ...
  var $_3tlt291acjepbvhlf = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_2zektj19zjepbvhjx.descendant($_ftrhrp192jepbvhgw.fromDom(document.body), editor.settings.ui_container).fold($_85l037171jepbvh93.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_b8glwm1a8jepbvhl1.register(editor);
    $_9p28zi1a2jepbvhkh.register(editor);
    $_51upis1aajepbvhla.register(editor);
    $_6qj2b21abjepbvhld.register(editor);
    $_3z1ode1a6jepbvhku.register(editor);
    $_5p8dj91a4jepbvhkk.register(editor);
    $_49hp5u1a7jepbvhkx.register(editor);
    $_3tlt291acjepbvhlf.register(editor);
    $_bexn0c1a9jepbvhl4.register(editor);
  };
  var $_9lwx4k19yjepbvhjt = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_279qck19ajepbvhhr.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_279qck19ajepbvhhr.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_10diqo17fjepbvhar,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_3pwm3o17tjepbvhcy,
      Panel: Panel,
      Movable: $_duqlu017hjepbvhaz,
      Resizable: $_1x6n2k17ujepbvhd1,
      ...
      FormatControls: $_9lwx4k19yjepbvhjt,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = create$3();
    $_9lwx4k19yjepbvhjt.setup(editor);
    $_e855h517wjepbvhd7.addToEditor(editor, panel);
    return $_abffit16djepbvh7p.get(editor, panel);
  });
  function Theme () {
  }
